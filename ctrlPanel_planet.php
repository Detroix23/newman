<!-- Dynamics - PLANET: Code generated by CtrlPanel V1-0 -->
                ...
                <table id="table-build" class="table-build1">
                    ...
                    <tr class="line-item-main">
                        ...
                        <td id="label-itemVal1-<?=$iid?>" class="label-itemValue1">
                            <input id="inp-numb-itemValue1-<?=$iid?>" class="inp-numb1 itemValue1" type="number" form="form-game" name="fBuild_<?=name?>_<?=$bname?>" value="<?= $bValSum ?>" />
                        </td>
