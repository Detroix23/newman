<?php 
	...
	*/
	...
	/// Load from session
	$saved_session = $_SESSION; 				# Saved session, before update by production (mostly to calc evolution)
	$session_ressource = $_SESSION[name]['r']; 	# Ressources
	$build_queue = []; 						# To be build
	$session_builds = $_SESSION[name]['b']; 	# Buildings
        ...
        <div class="ctnr-content">
            <div class="content">
                ...
                <table id="table-build" class="table-build1">
                    ...
                    <tbody>
                        <?php $iid = 0;
                            foreach ($session_builds as $bname => $bProds): /// Foreach buildings
                                $iid++;
                                $bValSum = 0;
