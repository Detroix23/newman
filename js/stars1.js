...
class SS {
    constructor(ctnr, list, id, speed=5.0, lean=1, size=50, acc=0) {
        ...
        this.elem.src = this.base + 1 + ".png";
        this.elem.id = 'ss' + this.id;
        this.elem.className = 'ss-star';
        this.elem.setAttribute("style", "transform: rotate(" + this.direction + "deg); bottom: " + this.y + "px; left: " + this.x + "px;");
        //// Code attributes
...
//// Generation
const sss = [];
const ss_ctnr = document.querySelector('#ctnr-sos');
let id = 0;
let speed = 0.5;
let lean = 0.5;
let size = 35;
